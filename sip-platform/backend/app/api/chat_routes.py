...
def query_chat(
    ...
    try:
        _, messages = chat_history_service.get_transcript(
            current_user.email,
            chat_request.session_id
        )
        ...
        # Create enhanced conversational query
        enhanced_query = f"""
        ...
        # Query RAG with memory-aware prompt
        result = rag_service.query(enhanced_query)
